...
imgs= {1: Image.open('Python\Leson10.py\image\cat1.png'),
       2: Image.open('Python\Leson10.py\image\cat2.png'),
       3: Image.open('Python\Leson10.py\image\cat3.png'),
       4: Image.open('Python\Leson10.py\image\cat4.png')}
